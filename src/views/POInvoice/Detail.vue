                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="width:85%;">
                        ...
                        {{ invoice.po.supplier.supplier_address
                        }}<br />
                    ...
                    <tr>
                      ...
                      <td style="width:85%;">
                        <span v-if="invoice.payment_method_id === 2">
                          ...
                          Tanggal Jatuh Tempo :
                          <b>{{
                            invoice.payment_due_date | moment
                          }}</b>
                        </span>
...
export default {
  ...
  methods: {
    getInvoice() {
      service
        .fetchData('/api/invoice/buy/show/' + this.$route.params.id)
        .then((response) => {
    ...
    processPayment() {
      ...
      if (validasi === true) {
        if (this.payment.nominal <= this.payment.total) {
          service
            .postData('/api/invoice/buy/pay', this.payment)
            .then((response) => {
    ...
    checkRemainingPayment() {
      service
        .fetchData('/api/invoice/buy/pay?invoice=' + this.invoice.id)
        .then((response) => {
