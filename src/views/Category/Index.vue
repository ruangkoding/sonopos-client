        ...
        <div class="card-body">
          ...
          <transition name="fade" v-if="showTable === true">
            <div v-if="mobile === true">
              <div class="card" v-for="v in categories" :key="v.id">
                <div class="card-body">
            ...
            <div class="table-responsive" v-else>
              <table class="table table-hover table-striped table-bordered">
                ...
                <tbody>
                  <tr v-for="v in categories" :key="v.id">
                    <td>{{ v.category_name }}</td>
                    <td>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Tambah Cabang Bisnis</h5>
                  <button
                    type="button"
                    class="close"
                    data-dismiss="modal"
                    ...
                    <div class="row">
                      <div class="form-group col-md-12">
                        ...
                        <input
                          ...
                          :class="{ 'is-invalid': validasi_create.category_name }"
                        />
                      </div>
                    </div>
                    <div class="row">
          ...
          <div class="modal fade" id="update_modal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Ubah Cabang Bisnis</h5>
                  <button
                    type="button"
                    class="close"
                    data-dismiss="modal"
                    ...
                    <div class="row">
                      <div class="form-group col-md-12">
                        ...
                        <input
                          ...
                          :class="{ 'is-invalid': validasi_update.category_name }"
                        />
                      </div>
                    </div>
                    <div class="row">
...
export default {
  ...
  methods: {
    ...
    getData(id) {
      service
        .fetchData(this.$apiUrl + '/category/' + id)
        .then((response) => {
    ...
    deleteData(id) {
      service
        .deleteData(this.$apiUrl + '/category?id=' + id)
        .then((response) => {
    ...
    postData(evt) {
      ...
      if (validate === true) {
        this.isLoading = true
        service
          .postData(this.$apiUrl + '/category', this.payload)
          .then((result) => {
    ...
    putData(evt) {
      ...
      if (validate === true) {
        this.isLoading = true
        service
          .putData(this.$apiUrl + '/category?id=' + this.id, this.category)
          .then((result) => {
            setTimeout(() => { this.isLoading = false }, 1000)
            if (result.status === 'ok') {
              this.$swal(
    ...
    validateCreate() {
      ...
      if (this.payload.category_name.length === 0) {
        this.validasi_create.category_name = true
        condition++
      } else {
        this.validasi_create.category_name = false
      }
    ...
    validateUpdate() {
      ...
      if (this.category.category_name.length === 0) {
        this.validasi_update.category_name = true
        condition++
      } else {
        this.validasi_update.category_name = false
      }
