          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST">
                ...
                <div class="row" v-if="checkout.is_po === '1'">
                  <div class="form-group col-md-12">
                    ...
                    <input
                      ...
                      :class="{
                        'is-invalid': validasi_checkout.po_number,
                      }" />
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="form-group col-md-12">
                    ...
                    <select
                      ...
                      class="form-control"
                      :class="{
                        'is-invalid': validasi_checkout.supplier_id }">
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      service
        .fetchData(this.$apiUrl + '/order/buy/cart?user=' + this.userid)
        .then((response) => {
          this.totalHarga = 0
    ...
    deleteData(id) {
      service
        .deleteData(this.$apiUrl + '/order/buy/cart?id=' + id)
        .then((response) => {
    ...
    checkOutCart() {
      ...
      if (validasi_checkout === true) {
        ...
        service
          .postData(this.$apiUrl + '/order/buy?user=' + this.userid, this.checkout)
          .then((response) => {
            if (response.status === 'ok') {
    ...
    addCartItem() {
      ...
      if (validasi_cart === true) {
        this.isLoading = true
        service
          .postData(this.$apiUrl + '/order/buy/cart?user=' + this.userid, this.cartitem)
          .then((result) => {
            setTimeout(() => {
              this.isLoading = false
            }, 1000)
    ...
    getSupplier() {
      service
        .fetchData(this.$apiUrl + '/supplier?all=true')
        .then((response) => {
  ...
  mounted() {
    service
      .fetchData(this.$apiUrl + '/ajax/ponumber')
      .then((response) => {
    ...
    service
      .fetchData(this.$apiUrl + '/ajax/poinvoice')
      .then((response) => {
